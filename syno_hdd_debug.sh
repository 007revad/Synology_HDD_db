...
###########################################################################################
# DEBUG VERSION  DEBUG VERSION  DEBUG VERSION  DEBUG VERSION  DEBUG VERSION  DEBUG VERSION
###########################################################################################
echo -e "\nDEBUG VERSION \n"
...
echo -e "\nClose and re-open Storage Manager then check if NVMe drive is missing."
echo -e "Line $LINENO \n"
pause
